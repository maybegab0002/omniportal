              ...
              <div>
                ...
                <label className="block w-full cursor-pointer">
                  <input
                    ...
                    required
                  />
                  <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-blue-500 hover:bg-blue-50 transition-colors">
